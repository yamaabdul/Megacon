...
public class ShowMenu {
	...
	out.append("		<ul>");
	out.append("			   	<li class='last'><a href='showRapportage.jsp?id_status=-1'><span>Overzicht</span></a></li>");
	out.append("    			<li class='has-sub'><a href='#'><span>Status</span></a>");
	out.append("		    		<ul>");
	out.append("			   		<li class='last'><a href='showWerkbonnen.jsp?id_status=0'><span>Nieuw</span></a></li>");
	...
	out.append("		</ul>");
	out.append("	</li>");
	out.append("	<li class='has-sub'><a href='#'><span>Onderdeel</span></a>");
	out.append("		<ul>");
	out.append("			<li class='last'><a href='showOnderdeel.jsp'><span>Overzicht standaardonderdeel</span></a></li>");
	out.append("			<li class='last'><a href='newOnderdeel.jsp'><span>New standaardonderdeel</span></a></li>");
	out.append("			<li class='last'><a href='showSubonderdeel.jsp'><span>Overzicht sub standaardonderdeel</span></a></li>");
	out.append("			<li class='last'><a href='newOnderdeel.jsp'><span>New sub standaardonderdeel</span></a></li>");
	out.append("	   </ul>");
	out.append("	</li>");
/*	out.append("	<li class='has-sub'><a href='#'><span>Zoeken</span></a>");
	...
	out.append("		 </ul>");
	out.append("	</li>");*/
	out.append("	<li class='has-sub'><a href='#'><span>Materiaal - bewerking</span></a>");
	out.append("		<ul>");
